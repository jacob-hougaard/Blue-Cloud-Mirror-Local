  ...
  <b-container class="about">
    ...
    <div>
      <b-form @submit="onSubmit">
        <b-form-group id="exampleInputGroup1" label="Nickname:" label-for="exampleInput1">
          <b-form-input
            id="exampleInput1"
            type="text"
            required
        ...
        <div style="margin-right:30px; margin-left:30px">
          ...
          style="height:10%;width:30%; background-color: #FFFFFF !important;border-color:black !important;"><font color="black">Play</font></b-button>
            <b-button
                    ...
                    type="submit"
                    v-if="!this.$store.state.isLoggedIn"
                    style="height:10%;width:30%; background-color: #FFFFFF !important;border-color:black !important;"><font color="black">An authenticated user must be logged in to register.</font></b-button>
          </center>
        </div>
      </b-form>
      <div></div>
