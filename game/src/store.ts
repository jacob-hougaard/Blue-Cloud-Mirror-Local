...
export default new Vuex.Store({
    ...
    state: {
        ...
        apis: {
            ...
            scores: {
                url: "https://bcm-conference.mybluemix.net/db/create" // default: scores-url-not-defined
            },
            login:{
                url: "https://bcm-conference.mybluemix.net/users/login"
            },
            twitter: {
        ...
        highscore: {
            url: "https://bcm-conference.mybluemix.net" // / default: highscore-url-not-defined
        },
        webcam: {
            width: 520,
            height: 440,
    ...
    mutations: {
        ...
        setConferenceId(state,payload){
          state.conferenceId = payload;
        },
